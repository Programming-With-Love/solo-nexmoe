...
<script type="text/javascript" src="${staticServePath}/skins/${skinDirName}/js/canvas.js?${staticResourceVersion}" charset="utf-8"></script>
...
<#--</audio>-->
<#--<script type="text/javascript" src="${staticServePath}/skins/${skinDirName}/js/headroom.js" charset="utf-8"></script>-->
<script type="text/javascript" src="${staticServePath}/js/common${miniPostfix}.js?${staticResourceVersion}" charset="utf-8"></script>
